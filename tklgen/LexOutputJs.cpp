...
static void MakeGetCharIndex(const TransitionSet& symbols,
                      std::wostream& stream,
                      bool code,
...
static void MakeGetNext2(const MapIntToCharInt& map,
                  std::wostream& stream,
                  MapIntToInt& finalTokenState,
                  const std::vector<std::wstring>& tokensNames,
                  int identationVal,
...
static void MakeGetNext(const MapIntToCharInt& map,
                 std::wostream& stream,
                 bool code,
                 MapIntToInt& finalTokenState,
                 const std::vector<std::wstring>& tokensNames,
...
static void MakeTokenEnum(const std::wstring& enumName0,
                   std::wostream& stream,
                   const std::vector<std::wstring>& tokensNames,
                   bool code,
                   const std::wstring& tokenPrefix,
...
static void MakeGetTokenFromState(const std::wstring& enumName0,
