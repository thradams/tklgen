                           ...
                           CommandLineOptions& commandLineOptions)
{
    ...
    for (size_t i = 0; i < args.size(); i++)
    {
        ...
        {
          commandLineOptions.m_bIsCpp = false;
        }
    }
}
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    try
    {
        ...
        if (commandLineOptions.m_bGenerateScanner)
        {
            ...
            GenerateScanner(grammar, fileOutNameDfa, commandLineOptions.m_bIsCpp);
        ...
        if (commandLineOptions.m_bGenerateParser)
        {
            ...
            std::wstring fileExtension = commandLineOptions.m_bIsCpp ? L".cpp" : L".cpp";
                ...
                commandLineOptions.m_bOverridescpp)
            {
                ...
                if (commandLineOptions.m_bIsCpp)
                {
