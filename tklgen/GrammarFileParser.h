...
namespace Grammar
{
    ...
    class Context
    {
        ...
        typedef Tokenizer<Grammar::DFA, InputStream> Scanner;
        
        private:
        Scanner& m_scanner;
        
        Grammar::Tokens m_CurrentToken;
    ...
    public:
        ...
        Grammar::Tokens Token() const
        {
             return m_CurrentToken;
        }
        
        //checks if Token() == tk and then move the current token
        void Match(Grammar::Tokens tk)
        {
